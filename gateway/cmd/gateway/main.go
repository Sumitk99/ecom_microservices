...
func main() {
	...
	corsPolicy := cors.Config{
		AllowOrigins:     []string{"https://ecom-frontend-git-master-sumit-kumars-projects-f58ba4dd.vercel.app", "https://ecom-frontend-beta-topaz.vercel.app", "http://localhost:4200"},
